...
export interface Browser<T> {
     ...
     * ```
     */
    getCookie(name: string): Browser<Cookie>;
     ...
     * ```
     */
    setCookie(cookie: Cookie): Browser<AnyResponse>;
     ...
     * @type protocol
     */
    buttonDown(button: number | Button): Browser<AnyResponse>;
     ...
     * ```
     */
    buttonPress(button: number | Button): Browser<AnyResponse>;
     ...
     * ```
     */
    buttonUp(button: number | Button): Browser<AnyResponse>;
     ...
     * ```
     */
    elementActive(): Browser<WebElementResponse>;
     ...
     * ```
     */
    elementIdAttribute(ID: string | number, attributeName: string): Browser<StringResponse>;
     ...
     * ```
     */
    execute(script: string | Function, ...args: any[]): Browser<AnyResponse>;
     ...
     * ```
     */
    frame(id?: string | number | WebElementJSONObject): Browser<AnyResponse>;
